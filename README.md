...
This theme tries to follow the color scheme a little more than the original, like changing additional elements to use a light pink that matches the https://vencord.dev website.
# Preview
