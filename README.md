...
This theme tries to follow the color scheme a little more than the original, like changing some elements to use light pink that matches the https://vencord.dev website.
# Preview
